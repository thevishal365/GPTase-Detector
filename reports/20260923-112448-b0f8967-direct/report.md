...
- **Date (UTC):** 2026-09-23T11:24:48+00:00
- **Mode:** direct (backend: `direct`)
...
|---|---|---|---|---|---|
| short (<30w) | 75 | 0.627 | 0.635 | 0.889 | 0.741 |
| medium (30-60w) | 51 | 0.765 | 0.700 | 0.875 | 0.778 |
| long (>60w) | 22 | 0.864 | 0.941 | 0.889 | 0.914 |

## Latency (all runs)

median 846 ms, p90 1442 ms, max 2345 ms (n=148).
