    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
        ...
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:px-6">
          <div className="flex items-center gap-2.5">
            <span
              ...
              aria-hidden="true"
            >
              <Icon d={PATHS.cpu} className="h-4.5 w-4.5" />
            </span>
      ...
      <main className="mx-auto max-w-6xl px-4 pb-16 sm:px-6">
        ...
        <section className="pb-6 pt-8 sm:pt-10" aria-labelledby="page-title">
          ...
          >
            Estimate whether text was written by a human or generated by AI.
          </h1>
            ...
            <div className="px-4 py-4 sm:px-5 sm:py-5">
              ...
              {workspaceState === "empty" && (
                <div className="py-6 text-center">
                  <span
                    className="mx-auto flex h-11 w-11 items-center justify-center rounded-lg border border-slate-200 bg-slate-50 text-slate-400"
                    aria-hidden="true"
                  >
